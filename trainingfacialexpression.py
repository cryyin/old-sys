...
# 全局变量
dataset_path = 'images'
output_model_path = 'models/face_expression-adam.hdf5'
output_plot_path = 'plots/face_expression-adam.png'
...
#H = model.fit(trainX, trainY, validation_data=(testX, testY),class_weight=classWeight, batch_size=BATCH_SIZE, epochs=EPOCHS, callbacks=callbacks, verbose=1)
