import torch
from oldcare.openpose.models.with_mobilenet import PoseEstimationWithMobileNet
from oldcare.openpose.modules.load_state import load_state
from oldcare.openpose.action_detect.net import NetV2
